function [bits] = enc_cavlc_Classification(data, nL, nU)
...
global QP AES_count AES_Bits QCx
global TargetedBt TargetedQC;
bits = '';
...
TargetedQC=iii;
% AESBit=AES_Bits(AES_count);
% if (AESBit~=0)
%     l(TargetedQC) = bitxor(l(TargetedQC),TargetedBt,'int64');
 Sign=[1 -1];   l(TargetedQC) = l(TargetedQC)*Sign(AES_Bits(AES_count)+1);
end
% end
%==========================================================================
